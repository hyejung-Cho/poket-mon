    ...
    if (u)
        return u = e,
            ...
            Mu(l) ? (t = "",
                ...
                gr(l, n, t, "", function (c) {
                    return c
                })) : l != null && (Bo(l) && (l = vc(l, t + (!l.key || u && u.key === l.key ? "" : ("" + l.key).replace(Du, "$&/") + "/") + e)),
                    n.push(l)),
            1;
    if (u = 0,
        r = r === "" ? "." : r + ":",
    ...
    e.unstable_IdlePriority = 5,
        ...
        e.unstable_scheduleCallback = function (_, P, z) {
            ...
            return G = z + G,
                ...
                z > W ? (_.sortIndex = z,
                    n(c, _),
                    t(s) === null && _ === t(c) && (k ? (f(N),
                        N = -1) : k = !0,
                        yl(v, z - W))) : (_.sortIndex = G,
                            n(s, _),
                            w || g || (w = !0,
                                vl(E))),
                _
...
var Qe = !(typeof window > "u" || typeof window.document > "u" || typeof window.document.createElement > "u")
    ...
    , Uu = {};
function Tc(e) {
    return Kl.call(Uu, e) ? !0 : Kl.call(Fu, e) ? !1 : zc.test(e) ? Uu[e] = !0 : (Fu[e] = !0,
        !1)
}
function Lc(e, n, t, r) {
    if (t !== null && t.type === 0)
...
var zs, qo, Ts, Ls, Rs, ao = !1, ir = [], rn = null, ln = null, on = null, jt = new Map, Mt = new Map, be = [], bc = "mousedown mouseup touchcancel touchend touchstart auxclick dblclick pointercancel pointerdown pointerup dragend dragstart drop compositionend compositionstart keydown keypress keyup input textInput copy cut paste click change contextmenu reset submit".split(" ");
function Yu(e, n) {
    switch (e) {
        case "focusin":
        case "focusout":
    ...
    switch (n) {
        ...
        case "gotpointercapture":
            return o = l.pointerId,
                Mt.set(o, dt(Mt.get(o) || null, e, n, t, r, l)),
                !0
    }
    return !1
}
...
function Lf(e, n) {
    if (Dn)
        return e === "compositionend" || !ru && Ds(e, n) ? (e = js(),
            Sr = eu = nn = null,
            Dn = !1,
            e) : null;
    switch (e) {
    ...
    if (!e[cr]) {
        e[cr] = !0,
            rs.forEach(function (t) {
                t !== "selectionchange" && (Hf.has(t) || Il(t, !1, e),
                    Il(t, !0, e))
            });
        ...
        if (!(n & 7)) {
            e: {
                if (p = e === "mouseover" || e === "pointerover",
                    ...
                    p && t !== lo && (w = t.relatedTarget || t.fromElement) && (Sn(w) || w[Ke]))
                    break e;
            ...
            if (ru)
                ...
                Dn ? Ds(e, t) && (N = "onCompositionEnd") : e === "keydown" && t.keyCode === 229 && (N = "onCompositionStart");
            N && (Ms && t.locale !== "ko" && (Dn || N !== "onCompositionStart" ? N === "onCompositionEnd" && Dn && (x = js()) : (nn = h,
                ...
                0 < C.length && (N = new Ju(N, e, null, t, h),
                    ...
                    x ? N.data = x : (x = Fs(t),
                        x !== null && (N.data = x)))),
                (x = zf ? Tf(e, t) : Lf(e, t)) && (c = Fr(c, "onBeforeInput"),
...
function ai(e, n, t, r, l) {
    for (var o = n._reactName, u = []; t !== null && t !== r;) {
        ...
        i.tag === 5 && c !== null && (i = c,
            l ? (s = It(t, o),
                s != null && u.unshift(At(t, s, i))) : l || (s = It(t, o),
...
function ua(e) {
    ...
    function s(f, a, d, v) {
        var E = d.type;
        return E === Mn ? h(f, a, d.props.children, v, d.key) : a !== null && (a.elementType === E || typeof E == "object" && E !== null && E.$$typeof === Je && Si(E) === a.type) ? (v = l(a, d.props),
            v.ref = ht(f, a, d),
            v.return = f,
    ...
    function k(f, a, d, v) {
        ...
        if (d = E.call(d),
            d == null)
            throw Error(y(151));
        for (var C = E = null, x = a, N = a = 0, H = null, L = d.next(); x !== null && !L.done; N++,
            L = d.next()) {
            x.index > N ? (H = x,
                x = null) : H = x.sibling;
    ...
    function D(f, a, d, v) {
        if (typeof d == "object" && d !== null && d.type === Mn && d.key === null && (d = d.props.children),
                    ...
                    e: {
                        for (var E = d.key, C = a; C !== null;) {
                            if (C.key === E) {
                                ...
                                } else if (C.elementType === E || typeof E == "object" && E !== null && E.$$typeof === Je && Si(E) === C.type) {
                                    t(f, C.sibling),
                                        a = l(C, d.props),
                                        a.ref = ht(f, C, d),
                                        a.return = f,
                        ...
                        d.type === Mn ? (a = xn(d.props.children, f.mode, v, d.key),
                            a.return = f,
...
var Xr = {
    ...
    , rd = {
        ...
        useCallback: function (e, n) {
            return Me().memoizedState = [e, n === void 0 ? null : n],
                e
        },
        useContext: Ce,
        useEffect: _i,
...
function zi(e, n, t, r, l) {
    if (e === null) {
        ...
        return typeof o == "function" && !zu(o) && o.defaultProps === void 0 && t.compare === null && t.defaultProps === void 0 ? (n.tag = 15,
            n.type = o,
            La(e, n, o, r, l)) : (e = Tr(t.type, null, r, n, n.mode, l),
                e.ref = n.ref,
                e.return = n,
                n.child = e)
    }
...
function Ti(e, n, t, r, l) {
    ...
    if (Zn(n, l),
        ...
        u.state = p,
            Qr(n, r, u, l),
            s = n.memoizedState,
            i !== r || p !== s || fe.current || qe ? (typeof h == "function" && (_o(n, t, h, r),
                s = n.memoizedState),
                (i = qe || wi(n, t, i, r, p, s, c)) ? (m || typeof u.UNSAFE_componentWillMount != "function" && typeof u.componentWillMount != "function" || (typeof u.componentWillMount == "function" && u.componentWillMount(),
        ...
        i !== m || p !== w || fe.current || qe ? (typeof g == "function" && (_o(n, t, g, r),
            w = n.memoizedState),
            (c = qe || wi(n, t, c, r, p, w, s) || !1) ? (h || typeof u.UNSAFE_componentWillUpdate != "function" && typeof u.componentWillUpdate != "function" || (typeof u.componentWillUpdate == "function" && u.componentWillUpdate(r, w, s),
        ...
        case 13:
            if (r = n.memoizedState,
                ...
                return r.dehydrated !== null ? (I($, $.current & 1),
                    n.flags |= 128,
                    null) : t & n.child.childLanes ? ja(e, n, t) : (I($, $.current & 1),
                        e = Xe(e, n, t),
                        ...
                        for (o in i)
                            if (i.hasOwnProperty(o)) {
                                ...
                                o === "style" ? ms(e, s) : o === "dangerouslySetInnerHTML" ? (s = s ? s.__html : void 0,
                                    s != null && ds(e, s)) : o === "children" ? typeof s == "string" ? (t !== "textarea" || s !== "") && Ot(e, s) : typeof s == "number" && Ot(e, "" + s) : o !== "suppressContentEditableWarning" && o !== "suppressHydrationWarning" && o !== "autoFocus" && (Rt.hasOwnProperty(o) ? s != null && o === "onScroll" && j("scroll", e) : s != null && Qo(e, o, s, u))
                            }
                        switch (t) {
                            case "input":
                                rr(e),
...
function cn(e) {
    return e.mode & 1 ? R & 2 && b !== 0 ? b & -b : qf.transition !== null ? (zr === 0 && (zr = Ns()),
        zr) : (e = O,
            e !== 0 || (e = window.event,
...
function kd(e, n, t) {
    ...
    r !== null && r.delete(n),
        ...
        J === e && (b & t) === t && (X === 4 || X === 3 && (b & 130023424) === b && 500 > Q() - Cu ? Cn(e, 0) : _u |= t),
        pe(e, n)
}
function Ga(e, n) {
    n === 0 && (e.mode & 1 ? (n = ur,
...
Za = function (e, n, t) {
    if (e !== null)
        ...
        ce = !1,
            U && n.flags & 1048576 && bs(n, Br, n.index);
    switch (n.lanes = 0,
    n.tag) {
        case 2:
            var r = n.type;
...
const tc = e => `./images/types-icons/${e}.svg`
    , Od = e => {
        const { id: n, name: t, sprites: r, weight: l, height: o, types: u } = e
            , i = l / 10 + "kg"
            , s = o / 10 + "m"
            , c = String(n).padStart(3, "0")
            , h = u.map(({ type: p }) => p)
            , m = r.other.dream_world.front_default || r.other["official-artwork"].front_default;
        return {
            ...e,
            paddedId: c,
            weight: i,
    ...
    , Id = e => e.replace(/-/g, " ")
    , jd = ({ toggleType: e }) => {
        const [n, t] = He.useState([]);
        return He.useEffect(() => {
            (async () => {
                const o = await fetch("https://pokeapi.co/api/v2/type/")
                    , { results: u } = await o.json();
                t(u.filter(({ name: i }) => i !== "unknown" && i !== "shadow" && i !== "stellar"))
            }
            )()
        }
            , []),
    ...
    , Md = ({ pokemon: { paddedId: e, name: n, types: t, imgSrc: r } }) => F.jsxs("div", {
        className: `pokemon-card ${t[0].name}`,
        children: [F.jsxs("div", {
            children: [F.jsx("span", {
                className: "id-number",
                children: "#" + e
    ...
    , Fd = ({ type: e }) => {
        ...
        return He.useEffect(() => {
            (async () => {
                l(!0);
                const u = `https://pokeapi.co/api/v2/type/${e}`
                    , i = await fetch(u)
                    , { pokemon: s } = await i.json()
                    , c = await Promise.all(s.map(async ({ pokemon: h }) => {
                        const p = await (await fetch(h.url)).json();
                        return Od(p)
                    }
                    ));
                return l(!1),
            ...
            , [e]),
            r ? F.jsx(Dd, {}) : F.jsx("div", {
                className: "pokemons-container",
                children: n.map(o => F.jsx(Md, {
                    pokemon: o
                }, o.id))
            })
    }
...
Ql.createRoot(document.getElementById("root")).render(F.jsx(kc.StrictMode, {
    children: F.jsx(Ud, {})
}));
